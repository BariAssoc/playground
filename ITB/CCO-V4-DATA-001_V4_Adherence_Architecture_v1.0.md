...
FORMULA:
  Days_Since_Last_Dose =
    Today minus Last_Confirmed_Date
...
V4 = (97 x 0.50) + (100 x 0.30) + (100 x 0.20)
   = 48.5 + 30.0 + 20.0
   = 98.5
...
"Mark — did you take your tirzepatide today?"
...
V4 = (70 x 0.50) + (30 x 0.30) + (75 x 0.20)
   = 35.0 + 9.0 + 15.0
   = 59.0
...
V4 = (73 x 0.50) + (85 x 0.30) + (55 x 0.20)
   = 36.5 + 25.5 + 11.0
   = 73.0
...
TRAC = [(V4 x 0.40) + (V1 x 0.35) + (V2 x 0.25)]
       x Multiplier
...
MARK_60DAY_SYNTHETIC_DATA_v1.1
  ...
  Pending recomputation with V4 formula
```
...
*BariAccess and RITHM are trademarks of BariAccess LLC.*
