...
VERSION:         v2.2
STATUS:          WORK IN PROGRESS — v2.2 ADDENDUM — PENDING VAL APPROVAL
LOCK DATE:       April 21, 2026
SUPERSEDES:      Program Canon v2.1 (April 20, 2026)
...
## §20. PROGRAM LIGHT — WAITING — PARKING LOT SLOT
*(Added: CCO-PROG-001 v2.2 — April 21, 2026)*

### §20.1 The Scenario

Patient completes Program Light (the educational/Learn portion of an ITB) and **declines** to proceed to Intervene (the therapeutic portion). They sign off on Light only. They do not abandon — they made a conscious choice to stop at Light.

This is a **legitimate canonical endpoint — not a failure state.**

### §20.2 The Slot — Locked

**SLOT NAME:** Program Light — Waiting
**STATE:** Waiting

This is a named Parking Lot slot. It sits inside the existing Parking Lot architecture alongside the other PLI slots per §15 of CCO-PROG-001 v2.1.

### §20.3 What Happens — Step by Step

| Step | Event |
|------|-------|
| 1 | Patient completes Light. Declines Intervene. Signs off on Light only. |
| 2 | Patient receives **partial credit** for Light completion. Light credits = collected. Intervene credits = not yet collected. Not lost. |
| 3 | Program enters slot: **Program Light — Waiting.** |
| 4 | **72-hour wait begins.** Patient may return and choose to Intervene at any point during this window. |
| 5 | If patient returns within 72 hours → patient clicks **REFRESH** → enters Intervene directly → does NOT restart Light → Light not replayed → Light credits already held → Intervene credits awarded on completion. |
| 6 | If patient does NOT return within 72 hours → program moves to **ARCHIVE** → standard PLI archive rules apply. |

### §20.4 Credit Rules — Locked

| Credit Type | Status |
|-------------|--------|
| Light credits | Collected at Light completion — held permanently — not deducted if patient returns later |
| Intervene credits | Separate — awarded only when Intervene is completed |
| No double dipping | Patient cannot collect Light credits twice. Light is not restarted when patient returns for Intervene. |

### §20.5 The Refresh Mechanic

When patient returns to a Program Light — Waiting slot and chooses to proceed:

- The word **REFRESH** appears
- Patient taps REFRESH
- Enters Intervene directly
- Intervene begins at Card 1 of the Intervene portion
- Light portion not shown again
- Light credits not re-awarded

**NOTE:** Exact UX of REFRESH button and transition animation: TBD. Owner: Valeriu E. Andrei, MD + Zakiy.

### §20.6 Relationship to Existing Canon

This slot is an extension of the **Branch Point Rule (§12)** and **Complete Lite state (§13)** already in CCO-PROG-001 v2.1. The 72-hour wait is consistent with the existing 72-hour behavioral commitment lock established in v2.0. Nothing in prior canon is contradicted by §20. This is **additive only.**

### §20.7 What Does Not Change

- The ITB Light structure
- The Intervene credit amount
...
```
═══════════════════════════════════════════════════════════════
END OF DOCUMENT — CCO-PROG-001 v2.2
STATUS: WORK IN PROGRESS — v2.2 ADDENDUM ADDED — PENDING VAL APPROVAL
AUTHORITY: Valeriu E. Andrei, MD | President | BariAccess LLC
CHANGE LOG: v2.2 — §20 added (Program Light — Waiting Slot)
═══════════════════════════════════════════════════════════════
```
