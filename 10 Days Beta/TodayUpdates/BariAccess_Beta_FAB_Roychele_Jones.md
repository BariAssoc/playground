...
**Document ID:** BETA-FAB-Roychele Jones-001
...
1. Confirm wake/sleep window for Roychele Jones from Day 1 Baseline (May 11 response)
2. Confirm whether Roychele Jones is on GLP-1 — if yes, add as critical FAB
