...
**Document ID:** BETA-FAB-Grace-001
...
1. Confirm wake/sleep window for Grace from Day 1 Baseline (May 11 response)
2. Confirm whether Grace is on GLP-1 — if yes, add as critical FAB
