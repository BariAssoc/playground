...
**Document ID:** BETA-FAB-Donna-001
...
1. Confirm wake/sleep window for Donna from Day 1 Baseline (May 11 response)
2. Confirm whether Donna is on GLP-1 — if yes, add as critical FAB
