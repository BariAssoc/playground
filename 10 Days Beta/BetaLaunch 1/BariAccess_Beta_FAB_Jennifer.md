...
**Document ID:** BETA-FAB-Jennifer-001
...
1. Confirm wake/sleep window for Jennifer from Day 1 Baseline (May 11 response)
2. Confirm whether Jennifer is on GLP-1 — if yes, add as critical FAB
