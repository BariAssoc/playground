...
**Document ID:** BETA-FAB-Madeline-001
...
1. Confirm wake/sleep window for Madeline from Day 1 Baseline (May 11 response)
2. Confirm whether Madeline is on GLP-1 — if yes, add as critical FAB
